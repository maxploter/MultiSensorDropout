...
from dataset.single_frame_moving_mnist import SingleDetectionMovingMNISTWrapper
...
def build_dataset(split, args, frame_dropout_pattern=None):
    ...
    if args.object_detection:
        ...
        dataset_class = DetectionMovingMNISTEasyWrapper
        if args.disable_recurrence:
            print("Disabling recurrent module")
            dataset_class = SingleDetectionMovingMNISTWrapper
